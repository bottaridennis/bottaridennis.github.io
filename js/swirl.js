...
function updateParticleColor(hue) {
  baseHue = hue; // Modifica la tonalità base delle particelle
  // Reinizializza le particelle per applicare immediatamente il nuovo colore
  initParticles();
}
